...
<html>
  ...
  <body>
  	...
  	<table border=0 align="center" width="400" cellspacing=0>
  		...
  		<form action="del_suborder.asp" method=post target="mainFrame">
      <tr>
        <input type="hidden" name="suborder_no" value="<%=suborder_no%>">
        <input type="hidden" name="order_no" value="<%=order_no%>">
        <input type="hidden" name="item_id" value="<%=item_id%>">
        <input type="hidden" name="serial_no" value="<%=serial_no%>">
        <input type="hidden" name="goto_url" value="edit_order.asp">
        <td>如果删除该订单项，则该订单项的数据信息将无法恢复！<br>确认删除请单击“删除”按钮，取消该操作请单击“取消”按钮。</td>
      </tr>
      <tr>
