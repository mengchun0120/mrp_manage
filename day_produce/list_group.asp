...
<table width="100%" cellspacing=1>
  ...
  <tr>
  	...
  	%>
  	    ...
  	    <th>
  	    	<input name="input_arrange" type="button" onclick="MM_goToURL('self','input_day_produce.asp?arrange_no=<%=rs4("arrange_no")%>&day_group=<%=rs("group_name")%>&notify_no=<%=rs4("notify_no")%>');return document.MM_returnValue" value="录入小组日产">
  	    </th>
  	    </tr>
  	<%
